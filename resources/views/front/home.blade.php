...
<div class="col-md-5">
    <select class="custom-select" placeholder= "اختر فصيلة الدم">
      @foreach($donations as $donation)
        <option>{{$donation->blood_type->name}}</option>
      @endforeach
...
<div class="col-md-5">
    <select class="custom-select">
      @foreach($donations as $donation)
        <option>{{$donation->city->name}}</option>
      @endforeach
      </select>
