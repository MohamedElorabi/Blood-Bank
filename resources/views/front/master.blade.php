...
<html lang="en">
  <head>
   ...
   <link rel="stylesheet" href="{{asset('front/css/hover-min.css')}}">
    ...
    <title>{{ !empty($title)?$title:'بنك الدم الرئيسية'}}</title>
  </head>
  <body>
     <!-- top nav section -->
    <section id="top-nav">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
           <div class="social-media">
              <a href = "{{$settings->fb_url}}" target="_blank"><i class="fab fa-facebook-f"></i></a>
              <a href = "{{$settings->ins_url}}" target="_blank"><i class="fab fa-instagram"></i></a>
              <a href = "{{$settings->tw_url}}" target="_blank"><i class="fab fa-twitter"></i></a>
              <a href = "{{$settings->wa_url}}" target="_blank"><i class="fab fa-whatsapp"></i></a>
     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="nav-logo " href="/"><img class="logo" src="{{asset('front/imgs/logo.png')}}"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link border-left" href="{{url('articles')}}">المقالات</a>
            </li>
            <li class="nav-item">
                <a class="nav-link border-left" href="{{url('donations')}}">طلبات التبرع</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link border-left" href="{{url('how-we-are')}}">من نحن</a>

                </li>
                <li class="nav-item">
                    <a class="nav-link border-left" href="{{url('contact-us')}}">اتصل بنا </a>
                  </li>
          </ul>
          @if(auth()->guard('client-web')->check())
           <span class="navbar-text">
               <a href="{{url('donation-request')}}"><button class="btn login-btn shadow">طلب تبرع</button></a>
           </span>
      ...
      <div class="col-md-4">
        <ul class="footer-list">
          <a href="/"><li> الرئيسيه</li></a>
            <a href="{{route('front.about')}}"><li> عن بنك الدم </li></a>
            <a href="{{route('front.articles')}}"> <li> المقالات </li></a>
            <a href="{{route('front.donations')}}"><li> طلبات التبرع </li></a>
            <a href="{{route('front.howWeAre')}}"> <li> من نحن </li></a>
            <a href="{{url('contact-us')}}">  <li> اتصل بنا </li></a>
...
<div class="col-md-4">
  <div class="social-media">
    <a href = "{{$settings->fb_url}}" target="_blank"><i class="fab fa-facebook-f hvr-float"></i></a>
    <a href = "{{$settings->ins_url}}" target="_blank"><i class="fab fa-instagram hvr-float"></i></a>
    <a href = "{{$settings->tw_url}}" target="_blank"><i class="fab fa-twitter hvr-float"></i></a>
    <a href = "{{$settings->wa_url}}" target="_blank"><i class="fab fa-whatsapp hvr-float"></i></a>
...
<p class="myname">Made with <i class="fas fa-heart"></i> by Mazen Anwar & <span>Developed by Mohamed Elorabi</span> </p>
